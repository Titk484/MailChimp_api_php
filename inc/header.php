                ...
                <div class="login">
                    <?php
                        ...
                        if($login_check==false) {
                            echo '<a style="color: #ab4f47; text-decoration: none;" href="login.php">Login</a></div>';
                        }else {
                            echo '<a style="color: #ab4f47; text-decoration: none;" href="?customer_id='.Session::get('customer_id').'">Logout</a></div>';
                        }
                    ?>
                </div>
            <div class="clear"></div>
